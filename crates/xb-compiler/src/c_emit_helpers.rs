...
pub(crate) fn emit_c_function_name(name: &str, out: &mut String) {
    match name {
        ...
        "XxxF2XM1" => out.push_str("xb_xxx_f2xm1"),
        "XxxFABS" => out.push_str("xb_xxx_fabs"),
        "XxxFCHS" => out.push_str("xb_xxx_fchs"),
        "XxxFCLEX" => out.push_str("xb_xxx_fclex"),
        "XxxFCOS" => out.push_str("xb_xxx_fcos"),
        "XxxFETOX" => out.push_str("xb_xxx_fetox"),
        "XxxFINIT" => out.push_str("xb_xxx_finit"),
        "XxxFLD1" => out.push_str("xb_xxx_fld1"),
        "XxxFLDL2E" => out.push_str("xb_xxx_fldl2e"),
        "XxxFLDL2T" => out.push_str("xb_xxx_fldl2t"),
        "XxxFLDLG2" => out.push_str("xb_xxx_fldlg2"),
        "XxxFLDLN2" => out.push_str("xb_xxx_fldln2"),
        "XxxFLDPI" => out.push_str("xb_xxx_fldpi"),
        "XxxFLDZ" => out.push_str("xb_xxx_fldz"),
        "XxxFPATAN" => out.push_str("xb_xxx_fpatan"),
        "XxxFPREM" => out.push_str("xb_xxx_fprem"),
        "XxxFPREM1" => out.push_str("xb_xxx_fprem1"),
        "XxxFPTAN" => out.push_str("xb_xxx_fptan"),
        "XxxFRNDINT" => out.push_str("xb_xxx_frndint"),
        "XxxFSCALE" => out.push_str("xb_xxx_fscale"),
        "XxxFSIN" => out.push_str("xb_xxx_fsin"),
        "XxxFSINCOS" => out.push_str("xb_xxx_fsincos"),
        "XxxFSQRT" => out.push_str("xb_xxx_fsqrt"),
        "XxxFSTCW" => out.push_str("xb_xxx_fstcw"),
        "XxxFSTSW" => out.push_str("xb_xxx_fstsw"),
        "XxxFTENTOX" => out.push_str("xb_xxx_ftentox"),
        "XxxFXTRACT" => out.push_str("xb_xxx_fxtract"),
        "XxxFYL2X" => out.push_str("xb_xxx_fyl2x"),
        "XxxFYL2XP1" => out.push_str("xb_xxx_fyl2xp1"),
        "XxxFYTOX" => out.push_str("xb_xxx_fytox"),
        _ => {
